...
export default function FuturisticPortfolio() {
	...
	useEffect(() => {
		...
		const cleanup = setupSectionObserver(
			["hero", "skills", "projects", "aspirations", "contact"],
			setActiveSection
		);
	...
	const aspirations = [
		{
			year: "2024",
			goal: "Master WebGL and 3D web development",
			icon: <Code className="w-5 h-5" />,
		},
		{
			year: "2025",
			goal: "Launch AI-powered development tools",
			icon: <Brain className="w-5 h-5" />,
		},
		{
			year: "2026",
			goal: "Contribute to open-source WebXR projects",
			icon: <Zap className="w-5 h-5" />,
		},
		{
			year: "2027",
			goal: "Build immersive metaverse experiences",
	...
	return (
		<div className="min-h-screen relative">
			...
			>
				...
				>
					<div className="animate-in slide-in-from-bottom-4 duration-1000">
						<h1 className="text-6xl md:text-8xl font-black bg-gradient-to-r from-purple-300 via-white to-purple-300 bg-clip-text text-transparent mb-6 bg-[length:200%_100%] animate-[shimmer_2s_ease-in-out_infinite]">
							Connor Duncan
						</h1>
					</div>
					<div className="animate-in slide-in-from-bottom-4 duration-1000 delay-200">
						<p className="text-xl md:text-2xl text-transparent bg-gradient-to-r from-purple-300 via-white to-purple-300 bg-clip-text mb-8 bg-[length:200%_100%] animate-[shimmer_2s_ease-in-out_infinite]">
							Full Stack Web Developer • Animation Architect • Fast Learner
						</p>
					</div>
			...
			<section id="skills" className="py-20 px-4 max-w-6xl mx-auto">
				<h2 className="text-4xl font-black text-center mb-16 bg-gradient-to-r from-purple-400 to-purple-600 bg-clip-text text-transparent hover:bg-gradient-to-r hover:from-purple-300 hover:via-white hover:to-purple-300 hover:bg-[length:200%_100%] hover:animate-[shimmer_2s_ease-in-out_infinite] transition-all duration-300 cursor-default">
					Technical Arsenal
				</h2>
						...
						<Card
							...
							className={`group cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 border-purple-500/20 hover:border-purple-400/50 bg-black/60 backdrop-blur-sm ${
								activeSkill === skill.name
									? "ring-2 ring-purple-400 shadow-2xl shadow-purple-500/25 scale-105"
									: ""
							}`}
							onClick={() =>
			...
			<section id="contact" className="py-20 px-4 max-w-4xl mx-auto">
				...
				<div className="grid md:grid-cols-2 gap-12">
					<div className="animate-in slide-in-from-left-4 duration-1000">
						<h3 className="text-2xl font-bold mb-6 text-white hover:bg-gradient-to-r hover:from-purple-300 hover:via-white hover:to-purple-300 hover:bg-clip-text hover:text-transparent hover:bg-[length:200%_100%] hover:animate-[shimmer_2s_ease-in-out_infinite] transition-all duration-300 cursor-default">
							Let's Build the Future
						</h3>
						<p className="text-purple-200 mb-8 leading-relaxed">
							Ready to push the boundaries of web development? Whether it's
							creating immersive experiences, building cutting-edge animations,
							or exploring new technologies, I'm always excited to collaborate
						...
						<div className="flex gap-4">
							<Button
								...
								onClick={() =>
									window.open("https://github.com/Zimpert", "_blank")
								}
							>
							...
							<Button
								...
								className="border-purple-400 text-purple-400 hover:bg-purple-600 hover:text-white bg-transparent hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl"
								onClick={() =>
									window.open("https://www.linkedin.com/in/connor-duncan-5868442b5", "_blank")
								}
							>
							...
							<Button
								...
								className="border-purple-400 text-purple-400 hover:bg-purple-600 hover:text-white bg-transparent hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl"
								onClick={() =>
									window.open("mailto:connorduncan1223@gmail.com", "_blank")
								}
							>
			...
			<footer className="py-8 px-4 text-center text-purple-300 border-t border-purple-500/20">
				<p>
					&copy; 2024 Connor Duncan. Crafted with passion and future-forward
					thinking.
				</p>
			</footer>
		</div>
